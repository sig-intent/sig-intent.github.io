...
const DICT = {
  ...
  es: {
    ...
    cta: {
      ...
      how: "Cómo trabajo",
      talk: "Hablemos",
      learn: "Leer la versión completa",
    },
    home: {
      hero_eyebrow: "CTO Fraccional · Cloud · IA · Arquitectura",
      hero_h1: "La mayoría de las decisiones tecnológicas están mal planteadas antes de ser respondidas.",
      hero_lead: "Para fundadores, CTOs y equipos directivos que se enfrentan a las apuestas en cloud, IA y arquitectura que no se deshacen fácilmente — te ayudo a replantear la decisión y luego a tomarla.",

      strip_1_label: "Experiencia",
      strip_1_text: "Dos décadas en gran empresa, consultoría y startups.",
      strip_2_label: "Rango",
      strip_2_text: "Profundidad de arquitecto, perspectiva de ejecutivo.",
      strip_3_label: "Modalidad",
      strip_3_text: "Fraccional, asesoría o proyectos cerrados.",

      services_eyebrow: "Compromisos",
      services_h2: "Compromisos selectivos donde el criterio técnico marca la diferencia.",
      services_lead: "Trabajo con un número reducido de clientes a la vez, alrededor de la decisión que importa — no de horas facturables. Y, a diferencia de los asesores que se detienen en la presentación, puedo quedarme para ayudar a llevar la estrategia hasta la entrega.",

      svc1_title: "CTO Fraccional o Interino",
      svc1_desc: "Liderazgo tecnológico ejecutivo sin necesidad de contratar a tiempo completo — para startups, scale-ups y empresas en transición.",
      ...
      svc2_title: "Revisión de Arquitectura",
      ...
      why_lead: "La IA puede generar cualquier respuesta en segundos. Eso abarata la respuesta — y encarece la pregunta. El cuello de botella se ha movido aguas arriba: saber qué problema resolver, qué tradeoffs son reales y dónde una decisión se acumulará en el tiempo. Eso es un problema de criterio, no de herramientas. Los perfiles generalistas que se mueven con fluidez entre arquitectura, producto, estrategia y operaciones son los mejor posicionados para tomar esas decisiones — porque la respuesta correcta casi nunca vive dentro de un único dominio.",
      why_c1: "Fluidez entre arquitectura, producto, estrategia y diseño organizativo.",
      why_c2: "Dos décadas de reconocimiento de patrones en gran empresa, consultoría y startups.",
      ...
      approach_lead: "La mayoría de los compromisos siguen el mismo ritmo — escuchar bien antes de opinar fuerte.",

      step1_t: "Diagnosticar",
      step1_d: "Primero el contexto. Dedico tiempo a fundadores, ingenieros y stakeholders para entender el problema real — no solo los síntomas que aparecen en el brief.",
      step2_t: "Replantear",
      ...
      about_p1: "Mis dominios principales son IA, cloud (con un fuerte sesgo hacia PaaS y serverless), arquitectura de software e ingeniería de software moderna. Pero mi trabajo se sitúa cada vez más un nivel por encima: conectando decisiones de arquitectura con estrategia de negocio, modelos operativos y apuestas tecnológicas a largo plazo.",
      about_p2: "Soy generalista por diseño — combinando profundidad técnica con transferencia entre dominios, moviéndome entre arquitectura, producto, estrategia y diseño organizativo. Esto me permite trabajar tanto en lo práctico como a nivel ejecutivo, según lo requiera la situación.",
